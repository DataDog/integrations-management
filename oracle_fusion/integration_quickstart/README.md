...
| `--confidential-application-id ID` | Hex ID of an existing confidential app to use instead of looking one up by name. Required when your app is not named "Datadog Fusion Integration". |
