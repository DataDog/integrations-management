...
" 2>/dev/null)
    [[ -z "$fusion_app_name" ]] && fatal \
        ...
        "Check that your local OCI credentials (~/.oci/config) are for the correct tenancy and region, and that your user has Identity Domain Administrator permissions on this domain."
