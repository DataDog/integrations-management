...
class TestExistingLfo(TestCase):
    ...
    def test_check_existing_lfo_single_installation(self):
        ...
        self.execute_mock.side_effect = self.make_execute_router(
            json.dumps(mock_func_apps),  # graph query for function apps
            {
                RESOURCE_TASK_NAME: {
                    ...
                    RESOURCE_TAG_FILTERS_KEY: self.config.resource_tag_filters,
                },
                SCALING_TASK_NAME: {
                    PII_SCRUBBER_RULES_KEY: self.config.pii_scrubber_rules,
                },
            },
        )
        ...
        self.assertEqual(existing_config.resource_tag_filters, self.config.resource_tag_filters)
        self.assertEqual(existing_config.pii_scrubber_rules, self.config.pii_scrubber_rules)
    ...
    # ===== find_existing_lfo_control_planes Tests ===== #

    def test_find_existing_lfo_control_planes_empty_subscriptions_set(self):
    ...
    def test_find_existing_lfo_control_planes_none_found(self):
    ...
    def test_find_existing_lfo_control_planes_parses_id_from_name(self):
    ...
    def test_find_existing_lfo_control_planes_installs_resource_graph_extension_if_missing(self):
    ...
    def test_find_existing_lfo_control_planes_subscriptions_filter_included_in_query(self):
    ...
    def test_find_existing_lfo_control_planes_invalid_json_raises(self):
    ...
    # ===== query_function_app_env_vars Tests ===== #

    def test_query_function_app_env_vars_returns_dict(self):
    ...
    def test_query_function_app_env_vars_invalid_json_raises(self):
