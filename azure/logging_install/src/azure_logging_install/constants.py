...
DIAGNOSTIC_SETTINGS_TASK_FUNCTION_APP_PREFIX = "diagnostic-settings-task-"
DIAGNOSTIC_SETTINGS_TASK_CONTAINER_APP_JOB_PREFIX = "diag-settings-task-"
DEPLOYER_TASK_PREFIX = "deployer-task-"
DEPLOYER_IMAGE_FOR_FUNCTION_APPS = "deployer:latest"
DEPLOYER_IMAGE_FOR_CONTAINER_APP_JOBS = "deployer-caj:latest"

MONITORED_SUBSCRIPTIONS_KEY = "MONITORED_SUBSCRIPTIONS"
RESOURCE_TAG_FILTERS_KEY = "RESOURCE_TAG_FILTERS"
PII_SCRUBBER_RULES_KEY = "PII_SCRUBBER_RULES"
DD_API_KEY_KEY = "DD_API_KEY"
DD_SITE_KEY = "DD_SITE"
DD_TELEMETRY_KEY = "DD_TELEMETRY"
