...
from gcp_integration_quickstart.models import Folder, Project
from gcp_integration_quickstart.scopes import (
...
class TestFetchFolders(unittest.TestCase):
    ...
    @patch("gcp_integration_quickstart.scopes.request")
...
class TestCollectConfigurationScopes(unittest.TestCase):
    ...
    @patch("gcp_integration_quickstart.scopes.gcloud")
    @patch("gcp_integration_quickstart.scopes.dd_request")
    @patch("gcp_integration_quickstart.scopes.request")
    @patch("gcp_integration_quickstart.scopes.fetch_folders")
